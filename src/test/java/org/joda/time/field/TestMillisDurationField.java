...
//        } catch (ClassCastException ex) {}
    ...
    public void testMillisDurationFieldTest_getTemplate(long l1, long l2, long l3, long l4, long l5, long l6) {
        assertEquals(l1, MillisDurationField.INSTANCE.getMillis(l2, 567L));
        assertEquals(l3, MillisDurationField.INSTANCE.getMillis(l4, 567L));
        assertEquals(l5, MillisDurationField.INSTANCE.getMillis(l6, 567L));
    }
}
